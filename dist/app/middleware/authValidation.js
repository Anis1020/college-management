...
const authValidation = (...requiredRole) => {
    return (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        const token = req.headers.authorization;
        console.log(token);
        if (!token) {
            throw new AppError_1.default(404, "you are not authorize user");
        }
        ...
        if (requiredRole && !requiredRole.includes(role)) {
            throw new AppError_1.default(401, "you are not unauthorize user");
        }
        req.user = decoded;
        next();
    }));
