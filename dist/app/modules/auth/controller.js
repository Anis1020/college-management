...
const changePassword = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield services_1.AuthServices.changePassword(req.user, passwordData);
    res.status(200).json({
        success: true,
...
const refreshToken = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield services_1.AuthServices.refreshToken(refreshToken);
    res.status(200).json({
        success: true,
...
const forgetPassword = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield services_1.AuthServices.forgetPassword(userId);
    res.status(200).json({
        success: true,
...
const resetPassword = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (token) {
        const result = yield services_1.AuthServices.resetPassword(req.body, token);
        res.status(200).json({
            success: true,
